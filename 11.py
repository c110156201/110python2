...
if (m==1 and (d>=21 and d<=31 )) or (m==2 and (d>=1 and d<=18 )):
    ...
    print("處女")
elif (m==9 and (d>=24 and d<=31 )) or (m==10 and (d>=1 and d<=23 )):
    print("天秤")
elif (m==10 and (d>=24 and d<=31 )) or (m==11 and (d>=1 and d<=23 )):
    print("天蠍")
elif (m==11 and (d>=24 and d<=31 )) or (m==12 and (d>=1 and d<=23 )):
    print("射手")
else:
    print("魔羯")